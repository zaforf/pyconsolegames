...
def askmove(x):
  ...
  while move not in possiblemoves: # make sure move is valid
    move = input("Enter "+x+"'s move: ")
  possiblemoves.remove(move)
  if move[0]=="a": # convert move into grid index
    return int(move[1])-1
  elif move[0]=="b":
    return int(move[1])+2
  elif move[0]=="c":
...
def checkwin():
  wins = ["012","345","678","036","147","258","048","246"] # 3 indices of each possible win
  for way in wins:
